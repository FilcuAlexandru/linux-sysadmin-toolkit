...
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml --check
```
...
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml -e 'disable_services=['cups']'
```
...
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml --check --diff

# 2) Apply to every host in the inventory.
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml

# 3) Limit to a host group.
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml --limit web

# 4) Prompt for the sudo password when the login user needs it.
ansible-playbook -i inventory.ini disable-unused-services/disable-unused-services.yml --ask-become-pass
```
...
ansible-verify:
  ...
  script:
    ...
    - yamllint ansible/
    - ansible-lint ansible/disable-unused-services/disable-unused-services.yml
    - ansible-playbook -i ansible/inventory.ini ansible/disable-unused-services/disable-unused-services.yml --syntax-check
```
...
ansible-pull -U https://github.com/YOUR_USER/linux-sysadmin-toolkit.git \
    ansible/disable-unused-services/disable-unused-services.yml
```
...
`ansible/disable-unused-services/disable-unused-services.yml`; expose the variables above as survey fields.
