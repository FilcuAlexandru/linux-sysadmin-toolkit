...
##################################################################
# Main.                                                          #
#   - Detects the available package manager (dpkg, rpm, or apk). #
#   - Lists installed packages sorted by name.                   #
#   - Outputs to stdout and optionally saves to LOG_FILE.        #
#   - Prints a summary line with the package count.              #
##################################################################
