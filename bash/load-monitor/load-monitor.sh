...
################################################################################
# Main.                                                                        #
#   - Reads load average from /proc/loadavg and core count from /proc/cpuinfo. #
#   - Prints 1/5/15-min averages with the effective limit (cores x ratio).     #
#   - Status-aware alerting: alerts once when 1-min load goes above threshold, #
